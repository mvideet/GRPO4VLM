...
def get_args():
    ...
    parser.add_argument("--use-curriculum", default=False, action='store_true',
                        help='Use curriculum learning (progressively increase maze size)')
    parser.add_argument("--curriculum-start-size", type=int, default=5,
                        help='Starting maze size for curriculum (default: 5)')
    parser.add_argument("--curriculum-end-size", type=int, default=100,
                        help='Final maze size for curriculum (default: 100)')
    parser.add_argument("--curriculum-progression", type=str, default="success_rate",
                        choices=["success_rate", "updates"],
                        help='Criterion for curriculum progression (default: success_rate)')
    parser.add_argument("--curriculum-success-threshold", type=float, default=0.7,
                        help='Success rate threshold to progress (default: 0.7)')
    parser.add_argument("--curriculum-min-episodes", type=int, default=100,
                        help='Minimum episodes before considering progression (default: 100)')
    parser.add_argument("--curriculum-updates-per-size", type=int, default=None,
                        help='Number of updates per size (if using updates criterion)')
